...
interface DashboardStats {
  ...
  activeTimersCount: number; // Number of active timers
}

export function useDashboardStats() {
  const { activeTimers, formatDuration } = useTimeTrackingContext();
  ...
  // Update active timers count immediately (real-time)
  useEffect(() => {
    setStats(prev => ({
      ...prev,
