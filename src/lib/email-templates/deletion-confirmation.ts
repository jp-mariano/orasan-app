/**
 * HTML template for account deletion confirmation email
 */
  ...
  return `
    ...
    <body>
      <div class="container">
        ...
        <p>Click the button below to confirm account deletion. This link will expire in <strong>24 hours</strong>:</p>
