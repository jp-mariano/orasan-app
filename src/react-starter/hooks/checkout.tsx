...
export type CheckoutPurchaseData = Parameters<
  NonNullable<CheckoutPopupEvents['success']>
>[0];
export type PurchaseSyncSuccess = (
  purchaseData: CheckoutPurchaseData
) => Promise<PurchaseData | undefined>;
...
export function useCheckoutEndpoint(): string | null {
  ...
  if (!context) {
    throw new Error(
      'useCheckoutEndpoint must be used within a CheckoutProvider'
    );
  }
