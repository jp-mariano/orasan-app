...
export const CancellationReason: Record<
  string,
  NonNullable<SubscriptionCancellationRequest['reason_ids']>[number]
> = {
...
export function getCancellationReasons(
  ...
  const baseReasons: CancellationReasonItem[] = [
    {
      id: CancellationReason.NOT_SURE_IF_NEEDED,
      label: "I'm not sure I want to keep it.",
    },
    {
      id: CancellationReason.DIFFICULT_TO_SET_UP,
      label: 'It was too difficult to set up.',
    },
    {
      id: CancellationReason.MISSING_FEATURES,
      label: "It didn't have the features I was looking for.",
    },
    {
      id: CancellationReason.SLOW_AND_BUGGY,
      label: 'It was too slow and/or buggy.',
    },
  ...
  if (!hasTrial) {
    baseReasons.push(
      {
        id: CancellationReason.WANT_PAYMENT_CONTROL,
        label: 'I want to control when I pay.',
      },
