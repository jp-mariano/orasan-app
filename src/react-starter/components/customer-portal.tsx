...
export function CustomerPortalUi(props: {
  ...
  return (
    <div className="fs-saas-starter-portal flex flex-col gap-16">
      ...
      {portalData.billing ? (
        <BillingSection billing={portalData.billing} user={portalData.user} />
      ) : null}

      {portalData.payments && portalData.payments.length > 0 ? (
        <PaymentsSection
          payments={portalData.payments}
          unit={portalData.sellingUnit}
        />
      ) : null}
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-2 mt-4">
            ...
            <Skeleton className="h-7 w-150 mt-4 max-w-full" />{' '}
            {/* Payment method */}
          </div>
        </div>
      </div>
