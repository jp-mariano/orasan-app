...
CREATE TYPE activity_action AS ENUM ('CREATE', 'UPDATE', 'DELETE', 'EXPORT_DATA', 'REQUEST_ACCOUNT_DELETION', 'CONFIRM_ACCOUNT_DELETION', 'CANCEL_ACCOUNT_DELETION', 'CHANGE_PASSWORD', 'REQUEST_EMAIL_CHANGE');
